...
def process_ais_data(decoded_message):
    ...
    try:
        ...
        heading = decoded_message.heading if hasattr(decoded_message, 'heading') else 'N/A'
        #status=<NavigationStatus.UnderWaySailing: 8>, turn=0.0, speed=26.8, course=144.8, heading=143, second=22, maneuver=<Ma, radio=114724
...
def index():
    ...
    return render_template("map.html", google_api_key=GOOGLE_API_KEY, target_msim=TARGET_MSIM)
